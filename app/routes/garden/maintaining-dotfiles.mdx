...
import image from "./dotfiles-repo-historical-commit-chart.png";
...
<img src={image} alt="A chart from GitHub showing increased contribution activity for my dotfiles repository after switching to the barefile method." />
